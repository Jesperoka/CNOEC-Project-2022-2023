...
# TODO: comment
def standardizedPlot(data, labels, title="Standardized Plot", xlabel="x-axis", ylabel="y-axis-1", ylabel2="y-axis-2", colorProfile="dark", twin=False, twinSep=None, figsize=(8, 6), labelFontSize=14):
